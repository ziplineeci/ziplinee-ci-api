...
type Client interface {
	SubscriptionForTopic(ctx context.Context, message PubSubPushMessage) (event *manifest.ZiplineePubSubEvent, err error)
...
func (c *client) SubscriptionForTopic(ctx context.Context, message PubSubPushMessage) (*manifest.ZiplineePubSubEvent, error) {
	...
	return &manifest.ZiplineePubSubEvent{
