...
func (m *MockClient) GetZiplineeManifest(ctx context.Context, accesstoken AccessToken, event RepositoryPushEvent) (bool, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetZiplineeManifest", ctx, accesstoken, event)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
...
func (mr *MockClientMockRecorder) GetZiplineeManifest(ctx, accesstoken, event interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetZiplineeManifest", reflect.TypeOf((*MockClient)(nil).GetZiplineeManifest), ctx, accesstoken, event)
}
