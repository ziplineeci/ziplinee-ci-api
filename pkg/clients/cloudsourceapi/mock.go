...
// GetZiplineeManifest mocks base method.
func (m *MockClient) GetZiplineeManifest(ctx context.Context, accesstoken AccessToken, notification PubSubNotification, gitClone func(string, string, string) error) (bool, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetZiplineeManifest", ctx, accesstoken, notification, gitClone)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
...
// GetZiplineeManifest indicates an expected call of GetZiplineeManifest.
func (mr *MockClientMockRecorder) GetZiplineeManifest(ctx, accesstoken, notification, gitClone interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetZiplineeManifest", reflect.TypeOf((*MockClient)(nil).GetZiplineeManifest), ctx, accesstoken, notification, gitClone)
}
