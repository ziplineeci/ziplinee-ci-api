...
func (c *loggingClient) GetGitTriggers(ctx context.Context, gitEvent manifest.ZiplineeGitEvent) (pipelines []*contracts.Pipeline, err error) {
...
func (c *loggingClient) GetGithubTriggers(ctx context.Context, githubEvent manifest.ZiplineeGithubEvent) (pipelines []*contracts.Pipeline, err error) {
	defer func() { api.HandleLogError(c.prefix, "Client", "GetGithubTriggers", err) }()

	return c.Client.GetGithubTriggers(ctx, githubEvent)
}

func (c *loggingClient) GetBitbucketTriggers(ctx context.Context, bitbucketEvent manifest.ZiplineeBitbucketEvent) (pipelines []*contracts.Pipeline, err error) {
