...
type Client interface {
	...
	GetGitTriggers(ctx context.Context, gitEvent manifest.ZiplineeGitEvent) (pipelines []*contracts.Pipeline, err error)
	...
	GetGithubTriggers(ctx context.Context, githubEvent manifest.ZiplineeGithubEvent) (pipelines []*contracts.Pipeline, err error)
	GetBitbucketTriggers(ctx context.Context, bitbucketEvent manifest.ZiplineeBitbucketEvent) (pipelines []*contracts.Pipeline, err error)
...
func (c *client) GetTriggers(ctx context.Context, triggerType, identifier, event string) (pipelines []*contracts.Pipeline, err error) {
	...
	trigger := manifest.ZiplineeTrigger{}

	switch triggerType {
	case "pipeline":
		trigger.Pipeline = &manifest.ZiplineePipelineTrigger{
			Event: event,
			Name:  identifier,
		}

	case "release":
		trigger.Release = &manifest.ZiplineeReleaseTrigger{
			Event: event,
			Name:  identifier,
		}

	case "cron":
		trigger.Cron = &manifest.ZiplineeCronTrigger{}

	case "git":
		trigger.Git = &manifest.ZiplineeGitTrigger{
			Event:      event,
			Repository: identifier,
		}

	case "pubsub":
		trigger.PubSub = &manifest.ZiplineePubSubTrigger{}

	case "github":
		trigger.Github = &manifest.ZiplineeGithubTrigger{
			Events:     []string{event},
			Repository: identifier,
		}

	case "bitbucket":
		trigger.Bitbucket = &manifest.ZiplineeBitbucketTrigger{
			Events:     []string{event},
			Repository: identifier,
		}
	...
	bytes, err := json.Marshal([]manifest.ZiplineeTrigger{trigger})
	if err != nil {
...
func (c *client) GetGitTriggers(ctx context.Context, gitEvent manifest.ZiplineeGitEvent) ([]*contracts.Pipeline, error) {
...
func (c *client) GetGithubTriggers(ctx context.Context, githubEvent manifest.ZiplineeGithubEvent) (pipelines []*contracts.Pipeline, err error) {
...
func (c *client) GetBitbucketTriggers(ctx context.Context, bitbucketEvent manifest.ZiplineeBitbucketEvent) (pipelines []*contracts.Pipeline, err error) {
