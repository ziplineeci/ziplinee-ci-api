...
import (
	...
	ziplinee_ci_contracts "github.com/ziplineeci/ziplinee-ci-contracts"
...
func (m *MockClient) DeleteClient(ctx context.Context, client ziplinee_ci_contracts.Client) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) DeleteGroup(ctx context.Context, group ziplinee_ci_contracts.Group) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) DeleteOrganization(ctx context.Context, organization ziplinee_ci_contracts.Organization) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) DeleteUser(ctx context.Context, user ziplinee_ci_contracts.User) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetAllNotifications(ctx context.Context, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField) ([]*ziplinee_ci_contracts.NotificationRecord, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllNotifications", ctx, pageNumber, pageSize, filters, sortings)
	ret0, _ := ret[0].([]*ziplinee_ci_contracts.NotificationRecord)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetAllPipelineBots(ctx context.Context, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField) ([]*ziplinee_ci_contracts.Bot, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllPipelineBots", ctx, pageNumber, pageSize, filters, sortings)
	ret0, _ := ret[0].([]*ziplinee_ci_contracts.Bot)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetAllPipelineBuilds(ctx context.Context, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField, optimized bool) ([]*ziplinee_ci_contracts.Build, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllPipelineBuilds", ctx, pageNumber, pageSize, filters, sortings, optimized)
	ret0, _ := ret[0].([]*ziplinee_ci_contracts.Build)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetAllPipelineReleases(ctx context.Context, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField) ([]*ziplinee_ci_contracts.Release, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllPipelineReleases", ctx, pageNumber, pageSize, filters, sortings)
	ret0, _ := ret[0].([]*ziplinee_ci_contracts.Release)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetBitbucketTriggers(ctx context.Context, bitbucketEvent ziplinee_ci_manifest.ZiplineeBitbucketEvent) ([]*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBitbucketTriggers", ctx, bitbucketEvent)
	ret0, _ := ret[0].([]*ziplinee_ci_contracts.Pipeline)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetCatalogEntities(ctx context.Context, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField) ([]*ziplinee_ci_contracts.CatalogEntity, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCatalogEntities", ctx, pageNumber, pageSize, filters, sortings)
	ret0, _ := ret[0].([]*ziplinee_ci_contracts.CatalogEntity)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetCatalogEntityByID(ctx context.Context, id string) (*ziplinee_ci_contracts.CatalogEntity, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetClientByClientID(ctx context.Context, clientID string) (*ziplinee_ci_contracts.Client, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClientByClientID", ctx, clientID)
	ret0, _ := ret[0].(*ziplinee_ci_contracts.Client)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetClientByID(ctx context.Context, id string) (*ziplinee_ci_contracts.Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetClients(ctx context.Context, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField) ([]*ziplinee_ci_contracts.Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetCronTriggers(ctx context.Context) ([]*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetFirstPipelineBuild(ctx context.Context, repoSource, repoOwner, repoName string, optimized bool) (*ziplinee_ci_contracts.Build, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetFirstPipelineRelease(ctx context.Context, repoSource, repoOwner, repoName, releaseName, releaseAction string) (*ziplinee_ci_contracts.Release, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetGitTriggers(ctx context.Context, gitEvent ziplinee_ci_manifest.ZiplineeGitEvent) ([]*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetGithubTriggers(ctx context.Context, githubEvent ziplinee_ci_manifest.ZiplineeGithubEvent) ([]*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetGroupByID(ctx context.Context, id string, filters map[api.FilterType][]string) (*ziplinee_ci_contracts.Group, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetGroupByID", ctx, id, filters)
	ret0, _ := ret[0].(*ziplinee_ci_contracts.Group)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetGroupByIdentity(ctx context.Context, identity ziplinee_ci_contracts.GroupIdentity) (*ziplinee_ci_contracts.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetGroups(ctx context.Context, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField) ([]*ziplinee_ci_contracts.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetLastPipelineBuild(ctx context.Context, repoSource, repoOwner, repoName string, optimized bool) (*ziplinee_ci_contracts.Build, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetLastPipelineBuildForBranch(ctx context.Context, repoSource, repoOwner, repoName, branch string) (*ziplinee_ci_contracts.Build, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetLastPipelineReleases(ctx context.Context, repoSource, repoOwner, repoName, releaseName, releaseAction string, pageSize int) ([]*ziplinee_ci_contracts.Release, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetOrganizationByID(ctx context.Context, id string) (*ziplinee_ci_contracts.Organization, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOrganizationByID", ctx, id)
	ret0, _ := ret[0].(*ziplinee_ci_contracts.Organization)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetOrganizationByIdentity(ctx context.Context, identity ziplinee_ci_contracts.OrganizationIdentity) (*ziplinee_ci_contracts.Organization, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetOrganizationByName(ctx context.Context, name string) (*ziplinee_ci_contracts.Organization, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetOrganizations(ctx context.Context, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField) ([]*ziplinee_ci_contracts.Organization, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipeline(ctx context.Context, repoSource, repoOwner, repoName string, filters map[api.FilterType][]string, optimized bool) (*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineBot(ctx context.Context, repoSource, repoOwner, repoName, botID string) (*ziplinee_ci_contracts.Bot, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineBotLogs(ctx context.Context, repoSource, repoOwner, repoName, botID string) (*ziplinee_ci_contracts.BotLog, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPipelineBotLogs", ctx, repoSource, repoOwner, repoName, botID)
	ret0, _ := ret[0].(*ziplinee_ci_contracts.BotLog)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetPipelineBotLogsByID(ctx context.Context, repoSource, repoOwner, repoName, botID, id string) (*ziplinee_ci_contracts.BotLog, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineBotLogsPerPage(ctx context.Context, repoSource, repoOwner, repoName, botID string, pageNumber, pageSize int) ([]*ziplinee_ci_contracts.BotLog, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineBots(ctx context.Context, repoSource, repoOwner, repoName string, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField) ([]*ziplinee_ci_contracts.Bot, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineBuild(ctx context.Context, repoSource, repoOwner, repoName, repoRevision string, optimized bool) (*ziplinee_ci_contracts.Build, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineBuildByID(ctx context.Context, repoSource, repoOwner, repoName, buildID string, optimized bool) (*ziplinee_ci_contracts.Build, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineBuildLogs(ctx context.Context, repoSource, repoOwner, repoName, repoBranch, repoRevision, buildID string) (*ziplinee_ci_contracts.BuildLog, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPipelineBuildLogs", ctx, repoSource, repoOwner, repoName, repoBranch, repoRevision, buildID)
	ret0, _ := ret[0].(*ziplinee_ci_contracts.BuildLog)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetPipelineBuildLogsByID(ctx context.Context, repoSource, repoOwner, repoName, buildID, id string) (*ziplinee_ci_contracts.BuildLog, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineBuildLogsPerPage(ctx context.Context, repoSource, repoOwner, repoName, repoBranch, repoRevision, buildID string, pageNumber, pageSize int) ([]*ziplinee_ci_contracts.BuildLog, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineBuilds(ctx context.Context, repoSource, repoOwner, repoName string, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField, optimized bool) ([]*ziplinee_ci_contracts.Build, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineBuildsByVersion(ctx context.Context, repoSource, repoOwner, repoName, buildVersion string, statuses []ziplinee_ci_contracts.Status, limit uint64, optimized bool) ([]*ziplinee_ci_contracts.Build, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineLastReleasesByName(ctx context.Context, repoSource, repoOwner, repoName, releaseName string, actions []string) ([]ziplinee_ci_contracts.Release, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineRecentBuilds(ctx context.Context, repoSource, repoOwner, repoName string, optimized bool) ([]*ziplinee_ci_contracts.Build, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineRelease(ctx context.Context, repoSource, repoOwner, repoName, releaseID string) (*ziplinee_ci_contracts.Release, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineReleaseLogs(ctx context.Context, repoSource, repoOwner, repoName, releaseID string) (*ziplinee_ci_contracts.ReleaseLog, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPipelineReleaseLogs", ctx, repoSource, repoOwner, repoName, releaseID)
	ret0, _ := ret[0].(*ziplinee_ci_contracts.ReleaseLog)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetPipelineReleaseLogsByID(ctx context.Context, repoSource, repoOwner, repoName, releaseID, id string) (*ziplinee_ci_contracts.ReleaseLog, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineReleaseLogsPerPage(ctx context.Context, repoSource, repoOwner, repoName, releaseID string, pageNumber, pageSize int) ([]*ziplinee_ci_contracts.ReleaseLog, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineReleases(ctx context.Context, repoSource, repoOwner, repoName string, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField) ([]*ziplinee_ci_contracts.Release, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelineTriggers(ctx context.Context, build ziplinee_ci_contracts.Build, event string) ([]*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelines(ctx context.Context, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField, optimized bool) ([]*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPipelinesByRepoName(ctx context.Context, repoName string, optimized bool) ([]*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetPubSubTriggers(ctx context.Context) ([]*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetReleaseTriggers(ctx context.Context, release ziplinee_ci_contracts.Release, event string) ([]*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetTriggers(ctx context.Context, triggerType, identifier, event string) ([]*ziplinee_ci_contracts.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetUserByID(ctx context.Context, id string, filters map[api.FilterType][]string) (*ziplinee_ci_contracts.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserByID", ctx, id, filters)
	ret0, _ := ret[0].(*ziplinee_ci_contracts.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetUserByIdentity(ctx context.Context, identity ziplinee_ci_contracts.UserIdentity) (*ziplinee_ci_contracts.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetUsers(ctx context.Context, pageNumber, pageSize int, filters map[api.FilterType][]string, sortings []api.OrderField) ([]*ziplinee_ci_contracts.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertBot(ctx context.Context, bot ziplinee_ci_contracts.Bot, jobResources JobResources) (*ziplinee_ci_contracts.Bot, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertBotLog(ctx context.Context, botLog ziplinee_ci_contracts.BotLog) (ziplinee_ci_contracts.BotLog, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertBuild(ctx context.Context, build ziplinee_ci_contracts.Build, jobResources JobResources) (*ziplinee_ci_contracts.Build, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertBuildLog(ctx context.Context, buildLog ziplinee_ci_contracts.BuildLog) (ziplinee_ci_contracts.BuildLog, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertCatalogEntity(ctx context.Context, catalogEntity ziplinee_ci_contracts.CatalogEntity) (*ziplinee_ci_contracts.CatalogEntity, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertClient(ctx context.Context, client ziplinee_ci_contracts.Client) (*ziplinee_ci_contracts.Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertGroup(ctx context.Context, group ziplinee_ci_contracts.Group) (*ziplinee_ci_contracts.Group, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertNotification(ctx context.Context, notificationRecord ziplinee_ci_contracts.NotificationRecord) (*ziplinee_ci_contracts.NotificationRecord, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertOrganization(ctx context.Context, organization ziplinee_ci_contracts.Organization) (*ziplinee_ci_contracts.Organization, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertRelease(ctx context.Context, release ziplinee_ci_contracts.Release, jobResources JobResources) (*ziplinee_ci_contracts.Release, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertReleaseLog(ctx context.Context, releaseLog ziplinee_ci_contracts.ReleaseLog) (ziplinee_ci_contracts.ReleaseLog, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) InsertUser(ctx context.Context, user ziplinee_ci_contracts.User) (*ziplinee_ci_contracts.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateBotStatus(ctx context.Context, repoSource, repoOwner, repoName, botID string, botStatus ziplinee_ci_contracts.Status) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateBuildStatus(ctx context.Context, repoSource, repoOwner, repoName, buildID string, buildStatus ziplinee_ci_contracts.Status) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateCatalogEntity(ctx context.Context, catalogEntity ziplinee_ci_contracts.CatalogEntity) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateClient(ctx context.Context, client ziplinee_ci_contracts.Client) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateComputedPipelinePermissions(ctx context.Context, pipeline ziplinee_ci_contracts.Pipeline) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateGroup(ctx context.Context, group ziplinee_ci_contracts.Group) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateOrganization(ctx context.Context, organization ziplinee_ci_contracts.Organization) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateReleaseStatus(ctx context.Context, repoSource, repoOwner, repoName, releaseID string, releaseStatus ziplinee_ci_contracts.Status) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateUser(ctx context.Context, user ziplinee_ci_contracts.User) error {
	m.ctrl.T.Helper()
