...
func (c *tracingClient) GetGitTriggers(ctx context.Context, gitEvent manifest.ZiplineeGitEvent) (pipelines []*contracts.Pipeline, err error) {
...
func (c *tracingClient) GetGithubTriggers(ctx context.Context, githubEvent manifest.ZiplineeGithubEvent) (pipelines []*contracts.Pipeline, err error) {
...
func (c *tracingClient) GetBitbucketTriggers(ctx context.Context, bitbucketEvent manifest.ZiplineeBitbucketEvent) (pipelines []*contracts.Pipeline, err error) {
