...
func (c *metricsClient) GetGitTriggers(ctx context.Context, gitEvent manifest.ZiplineeGitEvent) (pipelines []*contracts.Pipeline, err error) {
	defer func(begin time.Time) {
...
func (c *metricsClient) GetGithubTriggers(ctx context.Context, githubEvent manifest.ZiplineeGithubEvent) (pipelines []*contracts.Pipeline, err error) {
	defer func(begin time.Time) {
...
func (c *metricsClient) GetBitbucketTriggers(ctx context.Context, bitbucketEvent manifest.ZiplineeBitbucketEvent) (pipelines []*contracts.Pipeline, err error) {
	defer func(begin time.Time) {
