...
func (h *Handler) Handle(c *gin.Context) {
	...
	go func() {
		...
		err = h.service.PublishBitbucketEvent(ctx, manifest.ZiplineeBitbucketEvent{
			Event:         eventType,
...
func (h *Handler) Descriptor(c *gin.Context) {
	...
	descriptor := Descriptor{
		Key:         key,
		Name:        "Ziplinee",
		Description: "Ziplinee - The resilient and cloud-native CI/CD platform",
		Vendor: DescriptorVendor{
			Name: "Ziplinee",
			URL:  "https://ziplinee.io",
		},
