...
func (m *MockService) PublishBitbucketEvent(ctx context.Context, bitbucketEvent manifest.ZiplineeBitbucketEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockService) PublishGitEvent(ctx context.Context, gitEvent manifest.ZiplineeGitEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockService) PublishGithubEvent(ctx context.Context, githubEvent manifest.ZiplineeGithubEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockService) ReceiveBitbucketEvent(bitbucketEvent *manifest.ZiplineeBitbucketEvent) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReceiveCronEvent(cronEvent *manifest.ZiplineeCronEvent) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReceiveGitEvent(gitEvent *manifest.ZiplineeGitEvent) {
	m.ctrl.T.Helper()
...
func (m *MockService) ReceiveGithubEvent(githubEvent *manifest.ZiplineeGithubEvent) {
	m.ctrl.T.Helper()
