...
func (s *metricsService) CreateRelease(ctx context.Context, release contracts.Release, mft manifest.ZiplineeManifest, repoBranch, repoRevision string) (r *contracts.Release, err error) {
...
func (s *metricsService) CreateBot(ctx context.Context, bot contracts.Bot, mft manifest.ZiplineeManifest, repoBranch string) (b *contracts.Bot, err error) {
...
func (s *metricsService) FireGitTriggers(ctx context.Context, gitEvent manifest.ZiplineeGitEvent) (err error) {
...
func (s *metricsService) FirePubSubTriggers(ctx context.Context, pubsubEvent manifest.ZiplineePubSubEvent) (err error) {
	defer func(begin time.Time) {
...
func (s *metricsService) FireCronTriggers(ctx context.Context, cronEvent manifest.ZiplineeCronEvent) (err error) {
	defer func(begin time.Time) {
...
func (s *metricsService) FireGithubTriggers(ctx context.Context, githubEvent manifest.ZiplineeGithubEvent) (err error) {
	defer func(begin time.Time) {
...
func (s *metricsService) FireBitbucketTriggers(ctx context.Context, bitbucketEvent manifest.ZiplineeBitbucketEvent) (err error) {
	defer func(begin time.Time) {
...
func (s *metricsService) UpdateBuildStatus(ctx context.Context, event contracts.ZiplineeCiBuilderEvent) (err error) {
	defer func(begin time.Time) {
...
func (s *metricsService) UpdateJobResources(ctx context.Context, event contracts.ZiplineeCiBuilderEvent) (err error) {
	defer func(begin time.Time) {
...
func (s *metricsService) GetEventsForJobEnvvars(ctx context.Context, triggers []manifest.ZiplineeTrigger, events []manifest.ZiplineeEvent) (triggersAsEvents []manifest.ZiplineeEvent, err error) {
	defer func(begin time.Time) {
