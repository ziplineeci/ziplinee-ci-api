...
// Package ziplinee is a generated GoMock package.
package ziplinee
...
func (m *MockService) CreateBot(ctx context.Context, bot contracts.Bot, mft manifest.ZiplineeManifest, repoBranch string) (*contracts.Bot, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) CreateRelease(ctx context.Context, release contracts.Release, mft manifest.ZiplineeManifest, repoBranch, repoRevision string) (*contracts.Release, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) FireBitbucketTriggers(ctx context.Context, bitbucketEvent manifest.ZiplineeBitbucketEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockService) FireCronTriggers(ctx context.Context, cronEvent manifest.ZiplineeCronEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockService) FireGitTriggers(ctx context.Context, gitEvent manifest.ZiplineeGitEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockService) FireGithubTriggers(ctx context.Context, githubEvent manifest.ZiplineeGithubEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockService) FirePubSubTriggers(ctx context.Context, pubsubEvent manifest.ZiplineePubSubEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockService) GetEventsForJobEnvvars(ctx context.Context, triggers []manifest.ZiplineeTrigger, events []manifest.ZiplineeEvent) ([]manifest.ZiplineeEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEventsForJobEnvvars", ctx, triggers, events)
	ret0, _ := ret[0].([]manifest.ZiplineeEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) UpdateBuildStatus(ctx context.Context, event contracts.ZiplineeCiBuilderEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockService) UpdateJobResources(ctx context.Context, event contracts.ZiplineeCiBuilderEvent) error {
	m.ctrl.T.Helper()
