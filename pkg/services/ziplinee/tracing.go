...
func (s *tracingService) CreateRelease(ctx context.Context, release contracts.Release, mft manifest.ZiplineeManifest, repoBranch, repoRevision string) (r *contracts.Release, err error) {
...
func (s *tracingService) CreateBot(ctx context.Context, bot contracts.Bot, mft manifest.ZiplineeManifest, repoBranch string) (b *contracts.Bot, err error) {
...
func (s *tracingService) FireGitTriggers(ctx context.Context, gitEvent manifest.ZiplineeGitEvent) (err error) {
...
func (s *tracingService) FirePubSubTriggers(ctx context.Context, pubsubEvent manifest.ZiplineePubSubEvent) (err error) {
...
func (s *tracingService) FireCronTriggers(ctx context.Context, cronEvent manifest.ZiplineeCronEvent) (err error) {
...
func (s *tracingService) FireGithubTriggers(ctx context.Context, githubEvent manifest.ZiplineeGithubEvent) (err error) {
...
func (s *tracingService) FireBitbucketTriggers(ctx context.Context, bitbucketEvent manifest.ZiplineeBitbucketEvent) (err error) {
...
func (s *tracingService) UpdateBuildStatus(ctx context.Context, event contracts.ZiplineeCiBuilderEvent) (err error) {
...
func (s *tracingService) UpdateJobResources(ctx context.Context, event contracts.ZiplineeCiBuilderEvent) (err error) {
...
func (s *tracingService) GetEventsForJobEnvvars(ctx context.Context, triggers []manifest.ZiplineeTrigger, events []manifest.ZiplineeEvent) (triggersAsEvents []manifest.ZiplineeEvent, err error) {
