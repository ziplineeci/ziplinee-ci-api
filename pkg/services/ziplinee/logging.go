...
func NewLoggingService(s Service) Service {
	return &loggingService{s, "ziplinee"}
}
...
func (s *loggingService) CreateRelease(ctx context.Context, release contracts.Release, mft manifest.ZiplineeManifest, repoBranch, repoRevision string) (r *contracts.Release, err error) {
...
func (s *loggingService) CreateBot(ctx context.Context, bot contracts.Bot, mft manifest.ZiplineeManifest, repoBranch string) (b *contracts.Bot, err error) {
...
func (s *loggingService) FireGitTriggers(ctx context.Context, gitEvent manifest.ZiplineeGitEvent) (err error) {
...
func (s *loggingService) FirePubSubTriggers(ctx context.Context, pubsubEvent manifest.ZiplineePubSubEvent) (err error) {
	defer func() { api.HandleLogError(s.prefix, "Service", "FirePubSubTriggers", err) }()

	return s.Service.FirePubSubTriggers(ctx, pubsubEvent)
}

func (s *loggingService) FireCronTriggers(ctx context.Context, cronEvent manifest.ZiplineeCronEvent) (err error) {
	defer func() { api.HandleLogError(s.prefix, "Service", "FireCronTriggers", err) }()

	return s.Service.FireCronTriggers(ctx, cronEvent)
}

func (s *loggingService) FireGithubTriggers(ctx context.Context, githubEvent manifest.ZiplineeGithubEvent) (err error) {
	defer func() { api.HandleLogError(s.prefix, "Service", "FireGithubTriggers", err) }()

	return s.Service.FireGithubTriggers(ctx, githubEvent)
}

func (s *loggingService) FireBitbucketTriggers(ctx context.Context, bitbucketEvent manifest.ZiplineeBitbucketEvent) (err error) {
...
func (s *loggingService) UpdateBuildStatus(ctx context.Context, event contracts.ZiplineeCiBuilderEvent) (err error) {
	defer func() { api.HandleLogError(s.prefix, "Service", "UpdateBuildStatus", err) }()

	return s.Service.UpdateBuildStatus(ctx, event)
}

func (s *loggingService) UpdateJobResources(ctx context.Context, event contracts.ZiplineeCiBuilderEvent) (err error) {
	defer func() { api.HandleLogError(s.prefix, "Service", "UpdateJobResources", err) }()

	return s.Service.UpdateJobResources(ctx, event)
}

func (s *loggingService) GetEventsForJobEnvvars(ctx context.Context, triggers []manifest.ZiplineeTrigger, events []manifest.ZiplineeEvent) (triggersAsEvents []manifest.ZiplineeEvent, err error) {
